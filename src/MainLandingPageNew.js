      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          <NavRow>
            ...
            <DownloadLink target="_self" href="https://gum.co/QaruQ">
              Download Now
            </DownloadLink>
            <DownloadLink target="_self" href="components/innerPages/AboutBrentPage">
              AboutBrent
            </DownloadLink>
          </NavRow>
          {/*<HeroRow>*/}
          ...
          <SectionContainer>
            ...
            <PreviewCards>
              {Object.entries(innerPages).map(([pageName, page], index) => (
                <PreviewCardContainer key={index}>
                  <PreviewCard initial="rest" animate="rest" whileHover="hover" href={page.url} target="_self">
                    <PreviewCardImageContainer>
                      <PreviewCardImage
                        transition={{ type: "tween" }}
